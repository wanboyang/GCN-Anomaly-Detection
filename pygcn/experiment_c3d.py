...
def train_gcn(param):
    ...
    videos_pkl_train = "./ucf_crime_train.pkl"
    videos_pkl_test = "./ucf_crime_test.pkl"
    feature_folder = "/home/lnn/workspace/UCF_Crimes/c3d_features_all/_iter_4500/"
    prediction_folder = "./workspace/UCF_Crimes/c3d_features_1_high_conf_sampling_0.6/_iter_1000/"
    test_pred_gt_folder = "./data/UCF_Crimes/test_pred_groundtruth/"
    modality = "c3d"
    gpu_id = 0
    iter_size = 32
